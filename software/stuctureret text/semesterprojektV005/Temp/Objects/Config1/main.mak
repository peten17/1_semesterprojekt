...
export AS_PROJECT_PATH := C:/projects/semesterprojektV005
export AS_PROJECT_NAME := semesterprojektV005
export AS_SYSTEM_PATH := C:/BrAutomation/AS/System
export AS_VC_PATH := C:/BrAutomation/AS43/AS/VC
export AS_TEMP_PATH := C:/projects/semesterprojektV005/Temp
export AS_CONFIGURATION := Config1
export AS_BINARIES_PATH := C:/projects/semesterprojektV005/Binaries
...
export WIN32_AS_PROJECT_PATH := "C:\projects\semesterprojektV005"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS43\AS\VC"
export WIN32_AS_TEMP_PATH := "C:\projects\semesterprojektV005\Temp"
export WIN32_AS_BINARIES_PATH := "C:\projects\semesterprojektV005\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/semesterprojektV005.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndTransfer'  

	@$(AS_GNU_BIN_PATH)/mingw32-make.exe -r -f 'C:/projects/semesterprojektV005/Temp/Objects/$(AS_CONFIGURATION)/X20CP1382/#cpu.mak' -k 
