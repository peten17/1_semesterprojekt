...
PANEL_HW_SOURCE_Visu_R=C:/Users/peter/OneDrive/Dokumenter/GitHub/1_semesterprojekt/software/stuctureret\ text/semesterprojekt_v003/Physical/Config1/Hardware.hw 
...
$(TEMP_PATH_Visu_R)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Config1/X20CP1382/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu_R)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu_R)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu_R)/dis.PS2-Keyboard.vco)' -n Visu_Resized -d Visu_R -pal '$(PALFILE_Visu_R)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'I4.33' -L '' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu_R) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/Config1/X20CP1382/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.33.0/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'semesterprojekt' -sfas -vcob '$(VCOBJECT_Visu_R)'
...
CLM_SOURCES_Visu_R=$(AS_PROJECT_PATH)/Logical/Visu_Resized/ColorMaps/status.clm 
...
$(PANEL_HW_VCI_Visu_R): $(PANEL_HW_SOURCE_Visu_R) $(VC_LIBRARY_LIST_Visu_R) $(KEYMAP_SOURCES_Visu_R)
	$(VCHWPP) -f '$<' -o '$@' -n Visu_Resized -d Visu_R -pal '$(PALFILE_Visu_R)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'I4.33' -L '' -verbose 'False' -profile 'False' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu_R) -sos $(VC_STATIC_OPTIONS_Shared) -fp '$(AS_VC_PATH)/Firmware/V4.33.0/SG4' -sfas -prj '$(AS_PROJECT_PATH)' -apj 'semesterprojekt' -vcob '$(VCOBJECT_Visu_R)'
...
$(TEMP_PATH_Visu_R)/layer.CommonLayer_1.vco: $(AS_PROJECT_PATH)/Logical/Visu_Resized/Layers/CommonLayer_1.layer $(VC_LANGUAGES_Visu_R)
